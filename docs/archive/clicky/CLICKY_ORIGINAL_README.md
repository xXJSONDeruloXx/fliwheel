...
The original boot screenshots are not carried into the focused fliwheel
repository; this document remains as a text-only historical record.
...
-   [ ] Boot into RetailOS
    ...
    -   Research notes: [legacy RetailOS bring-up](../firmware/RETAILOS_BRINGUP.md)
    -   **Goals:**

...
| `99999` | Cubis 2 | Follow-up live-GL capture reaches the complete 49-draw main menu after the loader; background, Cubis logo, selection ornaments, labels, and font atlas are visible with the corrected default screen origin | Menu rendering verified; board, controls, audio, save, and full play remain open | Drive New Game into the isometric board, then verify cube launching/matching, pause/save, and audio |
